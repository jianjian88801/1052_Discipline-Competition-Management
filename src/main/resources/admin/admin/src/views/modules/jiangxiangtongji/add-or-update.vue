...
export default {
  ...
  computed: {
                                                                                                    zongshu: {
                                                                                                                                                                                                                                    get: function () {
        return 0+parseFloat(this.ruleForm.shuxue==""?0:this.ruleForm.shuxue)+parseFloat(this.ruleForm.wuli==""?0:this.ruleForm.wuli)+parseFloat(this.ruleForm.huaxue==""?0:this.ruleForm.huaxue)+parseFloat(this.ruleForm.shengwu==""?0:this.ruleForm.shengwu)+parseFloat(this.ruleForm.xinxixue==""?0:this.ruleForm.xinxixue) || 0
      }
    },
          },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinxixue = true;
            continue;
	            	            ...
	            	            if(o=='zongshu'){
            this.ruleForm.zongshu = obj[o];
	    this.ro.zongshu = true;
            continue;
          }
	                    }
                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiangxiangtongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiangxiangtongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
