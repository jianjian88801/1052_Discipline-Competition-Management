            ...
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="申报材料" prop="shenbaocailiao">
                <editor 
                    ...
                    v-model="ruleForm.shenbaocailiao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shenbaocailiao" label="申报材料" prop="shenbaocailiao">
                    <span v-html="ruleForm.shenbaocailiao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baomingriqi = true;
            continue;
	            	            ...
	            	            if(o=='shenbaocailiao'){
            this.ruleForm.shenbaocailiao = obj[o];
	    this.ro.shenbaocailiao = true;
            continue;
          }
	            	            if(o=='xuehao'){
	...
	this.ruleForm.shenbaocailiao = this.ruleForm.shenbaocailiao.replace(reg,'../../../springbootpx13e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `saixiangbaoming/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.saixiangbaomingCrossAddOrUpdateFlag = false;
                  this.parent.search();
